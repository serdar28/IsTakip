...
<?php
    include_once 'connection_settings.php';
    $id=$_GET['id'];
    $sorgu=$db->prepare("SELECT * FROM altoge WHERE id=:id");
    $sorgu->execute(array(
        ':id'=>$id
    ));
...
<div class="container">
  ...
  <form action="islem.php" method="post" class="was-validated">
    <div class="form-group">
      ...
      <input type="date" class="form-control" id="btarihi" name="btarihi" value="<?php echo $row['bildirimt']; ?>">
      <div class="valid-feedback"></div>
    </div>
    <div class="form-group">
      <label for="uname">Kayıt Açan:</label>
      <select name="uname" class="selectpicker form-control" data-live-search="true" >
      <option value="<?php echo $row['kayitAcanP']; ?>" selected> <?php echo $row['kayitAcanP']; ?> </option>
            <li class="divider"></li>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="uname" placeholder="Sorumlu Olan Kullanıcı" name="sorumlu" value="<?php echo $row['sorumluP']; ?>" required>
      <div class="valid-feedback"></div>
    </div>
    <div class="form-group">
      <label for="uname">Planlanan Bitiş Tarihi:</label>
      <input type="date" class="form-control" id="uname" name="pbtarih" value="<?php echo $row['pbtarihi']; ?>" required>
      <div class="valid-feedback"></div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" rows="5" id="comment" name="text"><?php echo $row['note']; ?> </textarea>
    </div>
    <div class="form-group">
     ...
     <div class="form-group">
      <input type="hidden" class="form-control" id="id" name="parentId" value="<?php echo $row['parentId']; ?>">
      <div class="valid-feedback"></div>
     </div>
    <button type="submit" class="btn btn-primary" name="updatealtoge">UPDATE</button>
  </form>
</div>
